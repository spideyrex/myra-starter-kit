...
/**
 * Bundle A's LOCAL fixture bridge (each bundle keeps its own copy on purpose).
 *
 ...
 * committed JSON is what tests/js/authLayoutFallback.spec.ts drives the client
 * guard from, so a drifting registry fails HERE first.
 */
trait SyncsAppearanceFixtures
{
