...
final class RuleCompiler
{
    ...
    private function rule(Builder $q, array $rule): Builder
    {
        ...
        return match ($operator) {
            ...
            Operator::Contains => $q->where($col, 'like', Sql::like((string) $value)),
            Operator::NotContains => $q->whereNot(fn (Builder $b) => $b->where($col, 'like', Sql::like((string) $value))),
            Operator::StartsWith => $q->where($col, 'like', Sql::like((string) $value, 'starts')),
            Operator::EndsWith => $q->where($col, 'like', Sql::like((string) $value, 'ends')),
