...
/**
 * Bundle C's LOCAL fixture bridge (each bundle keeps its own copy on purpose).
 *
 ...
 * committed JSON is what tests/js/demoRegistry.spec.ts mounts the real page
 * against, so a drifting server payload fails HERE first.
 */
trait SyncsDemoFixtures
{
