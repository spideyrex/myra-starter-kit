...
/**
 * Bundle B's LOCAL fixture bridge (each bundle keeps its own copy on purpose).
 *
 ...
 * committed JSON is what tests/js/exampleManifest.spec.ts mounts the real page
 * against, so a drifting server payload fails HERE first.
 */
trait SyncsExampleFixtures
{
